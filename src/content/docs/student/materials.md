---
title: "Akses Bahan Ajar & Modul Siswa"
---

Halaman Bahan Ajar di Portal Siswa menyediakan pustaka materi belajar digital yang disusun oleh tim pengajar bimbel agar siswa dapat belajar mandiri secara terarah di luar jam kelas tatap muka.
...
2.  **Video Belajar Interaktif (`interactive_video`)**: Video animasi atau penjelasan dari tutor yang dapat diputar secara langsung.
3.  **Buku Audio (`audio`)**: Penjelasan materi berupa rekaman suara untuk mendukung gaya belajar auditori.
4.  **Tugas & LKPD (`lkpd`)**: Lembar Kerja Peserta Didik untuk diunduh atau dikerjakan sebagai latihan mandiri.
5.  **Tautan Luar (`embed_link`)**: Link web referensi pembelajaran tambahan (seperti simulasi sains atau peta interaktif).
