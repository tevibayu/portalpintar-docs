---
title: "Bank Bahan Ajar & Modul Tutor"
---

Modul Bahan Ajar adalah pustaka digital interaktif bagi Tutor untuk mengakses, membagikan, dan mengelola materi pembelajaran, lembar kerja siswa (LKPD), serta video edukasi guna menunjang kegiatan belajar mengajar di bimbel.
...
2.  **Video Interaktif (`interactive_video`)**: Video penjelasan konsep pelajaran yang dapat langsung ditonton di dalam aplikasi.
3.  **Buku Audio (`audio`)**: Rekaman suara penjelasan materi untuk pembelajaran auditori.
4.  **LKPD / Lembar Kerja (`lkpd`)**: Lembar Kerja Peserta Didik untuk latihan soal, pekerjaan rumah (PR), atau kuis kelas.
5.  **Web Link (`embed_link`)**: Tautan ke situs web referensi luar (seperti simulasi PhET, Geogebra, atau artikel berita).
